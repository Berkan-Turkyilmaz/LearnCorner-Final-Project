    ...
    <>
      <div className="info-text-container">
        ...
        <p className="info-text">
          ...
          from A1 to B2, are designed to measure your skills in the language.
          Starting from the basics in A1 and progressing to more complex topics
          in B2, you can clearly track how your command of the language improves
          over time. Each level introduces specific grammar concepts and
          practical skills, helping you build a strong foundation and gradually
      ...
      <div className="card-container">
        <ReactCardFlip flipDirection="horizontal" isFlipped={isFlippedA1}>
          <div onClick={flipCardA1} className="card-front">
            ...
            <div className="text-a1">
              ...
              <p className="">
                Discover the basic topics right away. This is the perfect place
                to learn how to introduce yourself, engage in simple
                conversations, and master everyday expressions."
              </p>
            </div>
          </div>

          <div onClick={flipCardA1} className="card-back">
        ...
        <ReactCardFlip flipDirection="horizontal" isFlipped={isFlippedA2}>
          ...
          <div onClick={flipCardA2} className="card-back">
        ...
        <ReactCardFlip flipDirection="horizontal" isFlipped={isFlippedB1}>
          ...
          <div className="levels-and-icons">
            ...
            <div className="text-b1">
              ...
              <h4>
                You’ve developed your German skills, and now you’re ready for
                more complex topics
              </h4>
              <p>
                You can express your ideas in more depth and participate in a
                wider range of conversations.
              </p>
            </div>
          </div>

          <div onClick={flipCardB1} className="card-back">
        ...
        <ReactCardFlip flipDirection="horizontal" isFlipped={isFlippedB2}>
          ...
          <div className="levels-and-icons">
            ...
            <div className="text-b2">
              ...
              <p>
                You’re able to understand complex texts, present arguments, and
                engage in deep discussions on various topics.
              </p>
            </div>
          </div>

          <div onClick={flipCardB2} className="card-back">
